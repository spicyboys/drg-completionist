...
export const ChocolateReign = { png: _ChocolateReign, webp: _ChocolateReign_webp };
export const Colossus = { png: _Colossus, webp: _Colossus_webp };
export const DDarkFuture = { png: _DDarkFuture, webp: _DDarkFuture_webp };
export const DDefaultPaintjob = { png: _DDefaultPaintjob, webp: _DDefaultPaintjob_webp };
...
export const IntricateCarver = { png: _IntricateCarver, webp: _IntricateCarver_webp };
