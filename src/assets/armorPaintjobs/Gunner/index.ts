...
export const GDefaultPaintjob = { png: _GDefaultPaintjob, webp: _GDefaultPaintjob_webp };
...
export const MercuryBulwark = { png: _MercuryBulwark, webp: _MercuryBulwark_webp };
export const TopsoilDefender = { png: _TopsoilDefender, webp: _TopsoilDefender_webp };
