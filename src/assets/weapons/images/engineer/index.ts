...
export const DeepcoreGrenadeLauncher = { png: _DeepcoreGrenadeLauncher, webp: _DeepcoreGrenadeLauncher_webp };
export const StubbyVoltaicSMG = { png: _StubbyVoltaicSMG, webp: _StubbyVoltaicSMG_webp };
export const WarthogShotgun = { png: _WarthogShotgun, webp: _WarthogShotgun_webp };
