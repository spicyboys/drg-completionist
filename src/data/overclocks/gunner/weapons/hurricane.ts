...
const HurricaneOverclocks: Overclock[] = [
  {
    ...
    effects: {
      buffs: ['Releasing the trigger disables the guidance system', 'x1.33 Max Projectile Velocity'],
      nerfs: [],
    },
    description:
  ...
  },
  {
    ...
    effects: {
      ...
      nerfs: ['x0.5 Direct Damage', 'x0.5 Area Damage', 'x0.5 AoE Radius', 'x0.75 Max Velocity', '-108 Max Ammo'],
    },
    description:
  ...
  },
  {
    ...
    effects: {
      buffs: ['x2.5 Direct Damage', 'x1.5 Max Velocity', 'Projectiles Start at Max Speed'],
      nerfs: ['x0.5 Area Damage', '-0.5m AoE Radius', 'x0.75 Magazine Size', '-72 Max Ammo'],
    },
    description:
  ...
  },
  {
    ...
    effects: {
      buffs: ['Holding down the trigger now charges up a shotgun like blast of faster, unguided missiles that get a damage bonus the more missiles are in the salvo'],
      nerfs: [],
    },
    description:
